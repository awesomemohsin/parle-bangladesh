                ...
                <div className="text-left sm:text-right w-full sm:w-auto border-t sm:border-none pt-4 sm:pt-0">
                  ...
                  <div className="flex flex-col items-start sm:items-end gap-2 mt-3">
                    <div className="flex gap-2 w-full sm:w-auto">
                        ...
                        className={`flex-1 sm:flex-none px-3 py-2 border rounded-lg text-xs font-black uppercase tracking-widest focus:outline-none transition-all ${
                            hasChange ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
