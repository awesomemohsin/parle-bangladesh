          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="px-1.5 sm:px-2.5 py-3 text-[8.5px] sm:text-[9.5px] font-black text-gray-400 uppercase tracking-widest">Account ID</th>
                <th className="px-1.5 sm:px-2.5 py-3 text-[8.5px] sm:text-[9.5px] font-black text-gray-400 uppercase tracking-widest">Customer Info</th>
                
                <th 
                  className="px-1.5 sm:px-2.5 py-3 text-[8.5px] sm:text-[9.5px] font-black text-gray-400 uppercase tracking-widest text-center cursor-pointer hover:text-gray-900 transition-colors group"
                ...
                <th className="px-1.5 sm:px-2.5 py-3 text-[8.5px] sm:text-[9.5px] font-black text-gray-400 uppercase tracking-widest">Type</th>
                <th className="px-1.5 sm:px-2.5 py-3 text-[8.5px] sm:text-[9.5px] font-black text-gray-400 uppercase tracking-widest text-right">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {loading && customers.length === 0 ? (
                <tr>
                  <td colSpan={8} className="px-1.5 sm:px-2.5 py-20 text-center">
                ...
                customers.map((customer) => {
                  ...
                  return (
                    ...
                    <td className="px-1.5 sm:px-2.5 py-3">
                      <button
                        type="button"
                    ...
                    <td className="px-1.5 sm:px-2.5 py-3">
                      <div className="flex flex-col">
                        <div className="flex items-center gap-1.5 mb-0.5">
                          <span className="text-[11.5px] sm:text-sm font-black text-gray-900 uppercase tracking-tight leading-none">{customer.name || 'Anonymous'}</span>
                          {customer.isGuest && (
                    ...
                    <td className="px-1.5 sm:px-2.5 py-3 text-center">
                      <div className={`flex flex-col items-center ${sortBy === 'createdAt' ? 'text-red-600' : 'text-gray-500'}`}>
                        <span className="text-[9px] sm:text-[10.5px] font-black uppercase tracking-tighter">
                    ...
                    <td className="px-1.5 sm:px-2.5 py-3 text-center">
                      <div className={`flex items-center justify-center gap-0.5 text-xs sm:text-[13px] font-black tabular-nums italic ${sortBy === 'totalSpent' ? 'text-red-600' : 'text-red-600/70'}`}>
                    ...
                    <td className="px-1.5 sm:px-2.5 py-3 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <Button
                          ...
                          variant="outline"
                          className="h-8 px-2 sm:px-3 rounded-xl text-[7.5px] sm:text-[8.5px] font-black uppercase tracking-widest border-gray-200 text-gray-500 hover:bg-gray-50 flex items-center gap-1 shrink-0"
                        >
                        ...
                        {isStaff ? (
                          <div className="text-[7.5px] sm:text-[8.5px] font-black text-emerald-600 uppercase tracking-wider bg-emerald-50 px-2 py-1.5 rounded-xl border border-emerald-100 shrink-0">
                            Staff
                          </div>
                        ) : !customer.isGuest ? (
                          <Button
                            ...
                            className={`h-8 px-2 sm:px-3 rounded-xl text-[7.5px] sm:text-[8.5px] font-black uppercase tracking-widest transition-all shrink-0 ${
                              customer.customerType !== "customer"
                          ...
                          <div className="text-[7.5px] sm:text-[8.5px] font-black text-slate-400 uppercase tracking-wider bg-slate-100/60 px-2 py-1.5 rounded-xl shrink-0">
                            Guest
                          </div>
                        )}
                      </div>
