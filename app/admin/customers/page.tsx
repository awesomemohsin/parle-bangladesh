                      ...
                      <div className="flex items-center justify-end gap-1">
                        {isStaff ? (
                          ...
                          <Button
                            ...
                            className={`h-7.5 px-2 rounded-xl text-[7.5px] sm:text-[8px] font-black uppercase tracking-widest transition-all shrink-0 ${
                              customer.customerType !== "customer"
                          ...
                          <div className="text-[7.5px] sm:text-[8px] font-black text-slate-400 uppercase tracking-wider bg-slate-100/60 px-2 py-1.5 rounded-xl shrink-0">
                            Guest
                          </div>
                        )}
                        <Button
