          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="px-2 lg:px-4 py-3 text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest">Account ID</th>
                <th className="px-2 lg:px-4 py-3 text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest">Customer Info</th>
                
                <th 
                  className="px-2 lg:px-4 py-3 text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest text-center cursor-pointer hover:text-gray-900 transition-colors group"
                ...
                <th className="px-2 lg:px-4 py-3 text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest">Type</th>
                <th className="px-2 lg:px-4 py-3 text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest text-right">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {loading && customers.length === 0 ? (
                <tr>
                  <td colSpan={8} className="px-2 lg:px-4 py-20 text-center">
                  ...
                  return (
                    ...
                    <td className="px-2 lg:px-4 py-3.5">
                      <button
                        ...
                        className="font-mono text-[11px] sm:text-xs font-black text-blue-600 hover:text-blue-800 hover:underline cursor-pointer focus:outline-none"
                    ...
                    <td className="px-2 lg:px-4 py-3.5">
                      <div className="flex flex-col">
                        <div className="flex items-center gap-1.5 mb-0.5">
                          <span className="text-xs sm:text-sm font-black text-gray-900 uppercase tracking-tight leading-none">{customer.name || 'Anonymous'}</span>
                          {customer.isGuest && (
                             <span className="text-[7px] sm:text-[8px] font-black bg-gray-100 text-gray-500 px-1 py-0.2 rounded uppercase tracking-widest border border-gray-200">Guest</span>
                          )}
                        </div>
                        <div className="flex flex-wrap sm:flex-nowrap gap-1 sm:gap-2 text-[8px] sm:text-[10px] font-bold text-gray-400 uppercase tracking-tighter">
                    ...
                    <td className="px-2 lg:px-4 py-3.5 text-center">
                      <div className={`flex flex-col items-center ${sortBy === 'createdAt' ? 'text-red-600' : 'text-gray-500'}`}>
                        ...
                        <span className="text-[8px] sm:text-[9px] font-bold opacity-50">
                          {customer.createdAt ? format(new Date(customer.createdAt), "hh:mm a") : ""}
                        </span>
                      </div>
                    </td>
                    <td className="px-2 lg:px-4 py-3.5 text-center">
                      <span className={`text-xs sm:text-sm font-black tabular-nums italic ${sortBy === 'ordersCount' ? 'text-red-600' : 'text-gray-900'}`}>{customer.ordersCount || 0}</span>
                    </td>
                    <td className="px-2 lg:px-4 py-3.5 text-center">
                      <span className={`text-xs sm:text-sm font-black tabular-nums italic ${sortBy === 'totalProducts' ? 'text-red-600' : 'text-gray-900'}`}>{customer.totalProducts || 0}</span>
                    </td>
                    <td className="px-2 lg:px-4 py-3.5 text-center">
                      <div className={`flex items-center justify-center gap-0.5 text-xs sm:text-sm font-black tabular-nums italic ${sortBy === 'totalSpent' ? 'text-red-600' : 'text-red-600/70'}`}>
                        <span className="text-[9px] sm:text-[10px] not-italic">৳</span>
                        <span>{Math.round(customer.totalSpent || 0).toLocaleString()}</span>
                      </div>
                    </td>
                    <td className="px-2 lg:px-4 py-3.5">
                      <div className="flex flex-col gap-0.5 items-start">
                        <span className={`text-[8px] sm:text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest ${
                        ...
                        {customer.pendingApproval && (
                          <span className="text-[7px] sm:text-[8px] font-black bg-amber-50 text-amber-600 border border-amber-200 px-1.5 py-0.2 rounded uppercase tracking-widest animate-pulse mt-0.5">
                            Pending Verification
                          </span>
                        )}
                        {customer.flatDiscountPercent !== undefined && customer.flatDiscountPercent > 0 && (
                          <div className="flex flex-col text-[8px] sm:text-[9px] font-black text-gray-400 uppercase tracking-tighter mt-0.5">
                            <span className="text-red-600">{customer.flatDiscountPercent}% Flat Discount</span>
                            {customer.flatDiscountExpiresAt && (
                              <span className="text-[7px] sm:text-[8px] font-medium opacity-80 flex items-center gap-0.5 mt-0.5">
                    ...
                    <td className="px-2 lg:px-4 py-3.5 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <Button
                          ...
                          variant="outline"
                          className="h-8 px-2 sm:px-3.5 rounded-xl text-[8px] sm:text-[9px] font-black uppercase tracking-widest border-gray-200 text-gray-500 hover:bg-gray-50 flex items-center gap-1 shrink-0"
                        >
                        ...
                        {isStaff ? (
                          <div className="text-[8px] sm:text-[9px] font-black text-emerald-600 uppercase tracking-wider bg-emerald-50 px-2 py-1.5 rounded-xl border border-emerald-100 shrink-0">
                            Staff
                          </div>
                        ) : !customer.isGuest ? (
                          <Button
                            ...
                            className={`h-8 px-2 sm:px-3.5 rounded-xl text-[8px] sm:text-[9px] font-black uppercase tracking-widest transition-all shrink-0 ${
                              customer.customerType !== "customer"
                          ...
                          <div className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-wider bg-slate-100/60 px-2 py-1.5 rounded-xl shrink-0">
                            Guest
                          </div>
                        )}
                      </div>
