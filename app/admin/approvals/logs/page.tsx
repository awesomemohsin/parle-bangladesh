              ...
              <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="flex-1 space-y-5">
                  <div className="flex flex-wrap items-center gap-3">
                    <span className={`text-[9px] font-black text-white px-3 py-1 rounded-full uppercase tracking-widest ${request.status === 'approved' ? 'bg-emerald-600 shadow-lg shadow-emerald-200' :
                    ...
                    <div>
                      ...
                      {request.type === 'order' && request.targetDetails ? (
                        <div className="flex flex-wrap gap-2 items-center">
                          ...
                          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-50 px-2 py-1 rounded-lg">
                            {request.targetDetails.customerEmail}
                          </span>
                          <a 
                            href={`mailto:${request.targetDetails.customerEmail}`}
                            className="bg-slate-600 hover:bg-slate-700 text-white text-[8px] font-black px-2 py-1 rounded uppercase tracking-tighter transition-colors flex items-center gap-1 shadow-sm"
                          >
                          ...
                          <a 
                             ...
                             className="bg-blue-900 hover:bg-blue-950 text-white text-[8px] font-black px-2 py-1 rounded uppercase tracking-tighter transition-colors flex items-center gap-1 shadow-sm"
                           >
                           ...
                           <a 
                             ...
                             className="bg-green-600 hover:bg-green-700 text-white text-[8px] font-black px-2 py-1 rounded uppercase tracking-tighter transition-colors flex items-center gap-1 shadow-sm"
                           >
                  ...
                  <div className={`rounded-[1.5rem] border overflow-hidden ${request.status === 'approved' ? 'border-emerald-100 bg-emerald-50/5' :
