...
export default function SRShopSelector() {
  ...
  useEffect(() => {
    ...
    // 2. Load active shop from localStorage
  ...
  return (
    <div className="w-full bg-slate-900 border border-slate-800 rounded-3xl p-5 mb-8 shadow-xl relative overflow-visible" ref={dropdownRef}>
